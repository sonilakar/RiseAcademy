###
# Lists are containers for other objects. Lists are like a box. You can put dataframes, vectors, matrix
...
element1 <- rbind(element1, 
                  data.frame(name = c("Sheldon", "Chandler", "Jonas", "Masaba"),
                             age = c(30, 26, 17, 32),
                             salary = c(90000, 150000, 1000, 200000),
...
element3 <- matrix(1:10, ncol = 2, nrow = 5)
